...
export default function Home() {
  ...
  const collections = [
    ...
    { 
      ...
      link: '/catalogue?category=kids' 
    },
    { 
      name: 'Pet Wear', 
      image: '/images/hero/hero-3.jpg',
      link: '/catalogue?category=pets' 
    },
  ]
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="text-center p-8 bg-white border border-beige hover:border-cherryred transition-all duration-300 rounded-lg"
              >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center transform group-hover:translate-y-[-10px] transition-transform duration-500">
                      ...
                      <Link
                        ...
                        className="inline-block px-8 py-3 bg-cherryred text-ivory hover:bg-ivory hover:text-cherryred border border-cherryred uppercase text-sm tracking-widest font-medium transition-all rounded"
                      >
                        Explore
                      </Link>
                    </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="px-10 py-4 bg-cherryred text-ivory hover:bg-ivory hover:text-cherryred border border-cherryred uppercase text-sm tracking-widest font-semibold transition-all rounded"
              >
                WhatsApp Us Now
              </a>
              <Link
                href="/contact"
                className="px-10 py-4 bg-transparent border-2 border-ivory text-ivory hover:bg-ivory hover:text-charcoal uppercase text-sm tracking-widest font-semibold transition-all rounded"
              >
                Visit Our Store
              </Link>
            </div>
